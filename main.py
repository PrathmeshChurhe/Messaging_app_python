...
def main(page: ft.Page):
    ...
    page.title = "DSPL Message Applciation"
    ...
    def pick_files_result(e: ft.FilePickerResultEvent):
        ...
        if e.files != None:
            ...
            page.pubsub.send_all( Message(page.session.get("user_name"), image_path, message_type="chat_message", is_image=True))
            page.update()
...
ft.app(port= 8550 , target=main, assets_dir="assets" ,view=ft.WEB_BROWSER)